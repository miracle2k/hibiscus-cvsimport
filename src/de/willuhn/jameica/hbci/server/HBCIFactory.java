...
public class HBCIFactory {
  ...
  public static synchronized HBCIFactory getInstance()
	...
	/**
	 * Liefert den Passport fuer das angegebene Konto.
   ...
   */
  public synchronized Passport findImplementor(Passport passport) throws RemoteException, ClassNotFoundException
	{
		if (passport == null)
			throw new RemoteException("passport is null");

		if (passport.isNewObject())
			throw new RemoteException("passport does not exist in database");
